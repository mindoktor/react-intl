    ...
    function InjectIntl(props, context) {
      ...
      _this.translate = function (id, value) {
        if (typeof id === 'string' && id !== '') {
          return _this.context.intl.formatMessage.call(_this, { id: id }, value);
        }
    ...
    createClass(InjectIntl, [{
      ...
      value: function render() {
        ...
        return React.createElement(WrappedComponent, _extends({}, this.props, defineProperty({}, intlPropName, this.context.intl), {
          ref: withRef ?
          /* istanbul ignore next */function (ref) {
...
function formatMessage(config, state) {
  ...
  var gotKey = typeof messageDescriptor === 'string';
  var id = gotKey ? messageDescriptor : messageDescriptor.id;
  var defaultMessage = gotKey ? id : messageDescriptor.defaultMessage;
...
var IntlProvider = function (_Component) {
  ...
  function IntlProvider(props) {
    ...
    intlInstance.intl = _this.getChildContext().intl;
    return _this;
  }
...
function _t(msg, value) {
  if (msg) {
    // Handle both strings and message descriptors
    var id = typeof msg === 'string' ? msg : msg.id;
    if (intlInstance.intl.formatMessage) {
      return intlInstance.intl.formatMessage.call(this, { id: id }, value);
    }
    return id;
  }
...
export { addLocaleData, intlShape, injectIntl, defineMessages, IntlProvider, _t, FormattedDate, FormattedTime, FormattedRelative, FormattedNumber, FormattedPlural, FormattedMessage, FormattedHTMLMessage };
