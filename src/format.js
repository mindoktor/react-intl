...
export function formatMessage(
  ...
  const gotKey = typeof messageDescriptor === 'string';
  const id = gotKey ? messageDescriptor : messageDescriptor.id;
  const defaultMessage = gotKey ? id : messageDescriptor.defaultMessage;
